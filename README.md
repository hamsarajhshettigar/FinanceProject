...
```
export AIRFLOW_HOME="/home/hamsaraj/census_consumer_project/census_consumer_complaint/airflow"
```
...
```
airflow users create  -e hamsaraj@ineuron.ai -f hamsaraj -l Yadav -p admin -r Admin  -u admin
```
To start scheduler
```
airflow scheduler
